...
class Question(db.Model):
    ...
    content_es = db.Column(db.Text, nullable=False)
    content_zh = db.Column(db.Text, nullable=False)
    content_hi = db.Column(db.Text, nullable=False)
    content_ar = db.Column(db.Text, nullable=False)
    content_pt = db.Column(db.Text, nullable=False)
    ...
    content_pa = db.Column(db.Text, nullable=False)
    content_id = db.Column(db.Text, nullable=False)
